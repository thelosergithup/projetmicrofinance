                            ...
                            <div class="main-sparkline13-hd">
                                ...
                                if (($_SESSION["roleuser"] == "administrateur")) {
                                    ...
                                    <div class="add-product">
                                        <a href="<?= $url; ?>?page=<?php echo base64_encode('pmfpages/pmfutilisateur/pmfajouter/ajout_utilisateur'); ?>" class="btn btn-primary btn-sm pull-right"><i class="glyphicon glyphicon-plus"></i> Ajouter</a>
                                    </div>
                                    <?php
                                }
                                ?>
