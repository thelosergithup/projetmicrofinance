...
<div class="single-product-tab-area mg-tb-15">
    ...
    <div class="single-pro-review-area">
        ...
        <form id="edit_utilisateur" name="formutilisateurep" enctype="multipart/form-data" method="post" action="<?= $url; ?>?page=<?php echo base64_encode('sotcocogpages/sotcocogutilisateur/sotcocogediterprofil/edit_utilisateur'); ?>&idutilisateur=<?php echo $_REQUEST["idutilisateur"]; ?>&pagecom=<?php echo NUM_PAGE + 1; ?>" style="padding: 2%;">

            <input value="<?php echo $_SESSION['formutilisateurep'][NUM_PAGE]["idutilisateur"]; ?>" type="hidden" name="idutilisateur" id="idutilisateur" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="inputGroupContainer">
                            <div class="input-group">
                                ...
                                <input value="<?php echo $_SESSION['formutilisateurep'][NUM_PAGE]["nome"]; ?>" class="form-control" onkeyup="this.value = this.value.toUpperCase();" placeholder=" " type="text" name="nome" id="nome" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-4">
                    <div class="form-group">
                        ...
                        <div class="inputGroupContainer">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input value="<?php echo $_SESSION['formutilisateurep'][NUM_PAGE]["prenome"]; ?>" class="form-control" onkeyup="this.value = this.value.toLowerCase();" style="text-transform: capitalize;" placeholder="" type="text" name="prenome" id="prenome" />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-4 col-xs-4">
                            <div class="form-group">
                                ...
                                <div class="inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input value="<?php echo $_SESSION['formutilisateurep'][NUM_PAGE]["logine"]; ?>" class="form-control" placeholder="" type="text" name="logine" id="logine" />
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input value="<?php echo $_SESSION['formutilisateurep'][NUM_PAGE]["pass1e"]; ?>" class="form-control" placeholder="" type="password" name="pass1e" id="pass1e" />
                                    </div>
                                </div>
                            </div>
                        </div>
                <div class="col-md-4 col-sm-4 col-xs-4">
                            <div class="form-group">
                                ...
                                <div class="inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="fa fa-mail-forward"></i></span>
                                        <input value="<?php echo $_SESSION['formutilisateurep'][NUM_PAGE]["pass2e"]; ?>" class="form-control" placeholder="" type="password" name="pass2e" id="pass2e" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-8 col-sm-8 col-xs-8">
                    ...
                    <div class="form-group">
                        ...
                        <div class="inputGroupContainer">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input value="<?php echo $_SESSION['formutilisateurep'][NUM_PAGE]["tele"]; ?>" class="form-control" placeholder="" type="text" name="tele" id="tele" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="inputGroupContainer">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input value="<?php echo $_SESSION['formutilisateurep'][NUM_PAGE]["lignee"]; ?>" class="form-control" placeholder="" type="text" name="lignee" id="lignee" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="inputGroupContainer">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input value="<?php echo $_SESSION['formutilisateurep'][NUM_PAGE]["emaile"]; ?>" class="form-control" placeholder=" " type="text" name="emaile" id="emaile" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="inputGroupContainer">
                            <div class="input-group">
                                ...
                                <select class="form-control" name="genree" id="genree">
                                    ...
                                    <option value="Monsieur" <?php if ($_SESSION['formutilisateurep'][NUM_PAGE]["genree"] == "Monsieur") { ?> selected <?php } ?>>Monsieur</option>
                                    <option value="Madame" <?php if ($_SESSION['formutilisateurep'][NUM_PAGE]["genree"] == "Madame") { ?> selected <?php } ?>>Madame</option>
                                    <option value="Mademoiselle" <?php if ($_SESSION['formutilisateurep'][NUM_PAGE]["genree"] == "Mademoiselle") { ?> selected <?php } ?>>Mademoiselle</option>
                                </select>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-4 col-sm-4 col-xs-4">
                    <div class="form-group">
                        ...
                        <div class="fileupload fileupload-new" data-provides="fileupload">
                            <input type="hidden" name="photostring" value="<?php echo $_SESSION['formutilisateurep'][NUM_PAGE]['photostring']; ?>">
                            <img src="sotcocogupload/profil/<?php echo $_SESSION['formutilisateurep'][NUM_PAGE]['photostring']; ?>" style="width: 20mm; height: 20mm;">
