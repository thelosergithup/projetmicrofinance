                    ...
                    <div class="sparkline12-list mt-b-30">
                        <div class="sparkline12-hd">
                            <div class="main-sparkline12-hd">
                                <h1>Formulaire d'ajout d'un Pays</h1>
                            </div>
                        </div>
        <form id="ajout_pays" name="formpays" enctype="multipart/form-data" method="post" action="<?= $url; ?>?page=<?php echo base64_encode('sotcocogpages/sotcocogparametre/sotcocogpays/sotcocogajouter/ajout_pays'); ?>&pagecom=<?php echo NUM_PAGE + 1; ?>" style="padding: 2%;">
                    ...
                    <div class="form-group" style="margin-left:15px;">
                        ...
                        <div class="inputGroupContainer">
                            <div class="input-group">
                                ...
                                <input value="<?php echo $_SESSION['formpays'][NUM_PAGE]["codep"]; ?>" onkeyup="this.value = this.value.toUpperCase();" class="form-control" placeholder=" " type="text" name="codep" id="codep" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group" style="margin-left:15px;">
                        <label class="control-label" >Nom pays&nbsp;<g style="color: red">*</g></label>
                        <div class="inputGroupContainer">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input value="<?php echo $_SESSION['formpays'][NUM_PAGE]["pays"]; ?>" onkeyup="this.value = this.value.toLowerCase();" style="text-transform: capitalize;" class="form-control" placeholder="" type="text" name="pays" id="pays" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class=" panel-footer">
                <div class="row">
                    ...
                    <div class="col-sm-12 text-center">
                        <center><button id="validateBtn" type="submit" name="inspays" class="btn btn-success"><i class="glyphicon glyphicon-check"></i> Enregistrer</button>
