...
<div class="single-product-tab-area mg-tb-15">
    ...
    <div class="single-pro-review-area">
        ...
        <form id="ajout_ville" name="formville" enctype="multipart/form-data" method="post" action="<?= $url; ?>?page=<?php echo base64_encode('sotcocogpages/sotcocogparametre/sotcocogville/sotcocogajouter/ajout_ville'); ?>&pagecom=<?php echo NUM_PAGE + 1; ?>" style="padding: 2%;">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-control" name="pays" id="pays">
                                    ...
                                    while ($rowp = mysqli_fetch_assoc($rsltp)) {
                                        ?>
                                        <option value="<?php echo $rowp["idpays"]; ?>" <?php if ($rowp["idpays"] == $_SESSION['formville'][NUM_PAGE]["pays"]) { ?> selected <?php } ?>><?php echo $rowp["libellepays"]; ?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="form-group" style="margin-left:15px;">
                        ...
                        <div class="inputGroupContainer">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input value="<?php echo $_SESSION['formville'][NUM_PAGE]["ville"]; ?>" onkeyup="this.value = this.value.toLowerCase();" style="text-transform: capitalize;" class="form-control" placeholder="" type="text" name="ville" id="ville" />
                            </div>
                        </div>
                    </div>
                </div>
